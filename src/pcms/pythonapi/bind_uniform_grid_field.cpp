...
//   - UniformGridFieldLayout<N>  (layout, bound in
//   bind_uniform_grid_field_layout.cpp)
//   - LagrangeFunctionSpace::from_uniform_grid (a concrete FunctionSpace,
//     bound in bind_field_base.cpp)
//   - Field<Real> (bound in bind_field_base.cpp)
