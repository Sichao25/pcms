...
void pspltest1(double zctrl) {
  ...
  auto wk2_view = Kokkos::View<double*, TestMemorySpace>(
    zdum_view.data(), 1000);
  auto wk2 = Rank1View<double, TestMemorySpace>(wk2_view.data(), wk2_view.size());
...
void compare(const std::string &slbl,
             Rank1View<double, TestMemorySpace> x, int nx,
             Rank1View<double, TestMemorySpace> th, int nth,
...
void dotest2(Rank1View<double, TestMemorySpace> x,
  ...
  //                       nbc, bcth2, wk);
  BiCubicSplineInterpolator<double, TestMemorySpace> explicit_interpolator(
...
void pspltest2(double zctrl) {
  ...
  auto x1 =
      Rank1View<double, TestMemorySpace>(x1_view.data(), x1_view.size());
  auto ex1 = Rank1View<double, TestMemorySpace>(ex1_view.data(), ex1_view.size());
  auto t1 =
      Rank1View<double, TestMemorySpace>(t1_view.data(), t1_view.size());
  auto st1 = Rank1View<double, TestMemorySpace>(st1_view.data(), st1_view.size());
  auto ct1 = Rank1View<double, TestMemorySpace>(ct1_view.data(), ct1_view.size());
  ...
  auto extest =
      Rank1View<double, TestMemorySpace>(extest_view.data(), extest_view.size());
  auto ttest =
